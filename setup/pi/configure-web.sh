...
ln -sf /var/log/archiveloop.log /var/www/html/
...
curlwrapper -L -o /tmp/webui.tgz https://github.com/tete1030/teslausb-webui/releases/latest/download/teslausb-ui.tgz
